...
def run_callirhoe(style, size, args, outfile):
    ...
    @return: Popen object
    """
    return subprocess.Popen(['callirhoe', '-s', style, '--phantom-days',
...
def compose_calendar(img, outimg, options, callirhoe_args, magick_args, month, stats=None, cache=None):
